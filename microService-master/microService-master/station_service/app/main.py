...
from app.model.TuristBus import TuristBus as BusModel
...
async def add_turistbus(turistBus: BusModel.model, db: db_dependency):
    db_turistbus = TuristBus(model=BusModel.model,
